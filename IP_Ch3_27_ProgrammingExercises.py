...
# TODO: Ensure parentheses are balanced, and check if every operand has an operator in between
...
# Your evaluator should process infix tokens from left to right and use two stacks, one for operators and one for operands,
